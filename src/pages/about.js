          ...
          <div className="col-lg-7">
            <div className="col-lg-9 hero-text text-justify">
              ...
              <p className="hero-quote">
                ...
                algorithms, and have completed 2 courses on this subjects, and
                keep I learning everyday to improve my critical thinking skills.
              </p>
              <p className="hero-quote">
                ...
                should dive into Node.js or Python in the nearest future.
              </p>
              ...
              <p className="hero-quote">
                I am currently interested in freelancing, or getting a job in
